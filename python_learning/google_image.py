<<<<<<< HEAD:python_learning/google_image.py
#!/usr/bin/env python
# -*- coding: utf-8 -*-
...
class getProxies(object):
    ...
    def getHtmlText(self, url):
        prox = {'HTTP':'183.129.207.84:42155'}
        headers = {
...
def main():
    ...
    for file in download_files:
        ...
        print('%s start %d process' % (file,i / 10 + 1))
...
if __name__ == '__main__':
    main()
>>>>>>> 45097d95013786426194b0da606ae036651ab08b:NN_Model/google_image.py
